...
def test_geocommerce_imports():
    ...
    try:
        ...
        from geocommerce.config import GeoCommerceConfig
        print("  ✅ Config module")
        
        from geocommerce.shopify_connector import ShopifyGraphQLClient
        print("  ✅ Shopify connector")
        
        from geocommerce.api_data_processor import ShopifyDataProcessor
        print("  ✅ Data processor")
        
        from geocommerce.geocommerce_core import GeoCommerceAnalyzer
