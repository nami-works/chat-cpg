...
def handle_oraculo_flow(chat_interaction, chain, memory):
    ...
    """
    # Note: File processing functionality has been moved to the sidebar in chat_cpg.py
    st.info("💡 Para adicionar arquivos à base de conhecimento, use a aba 'Adicionar conhecimento' na barra lateral.")
