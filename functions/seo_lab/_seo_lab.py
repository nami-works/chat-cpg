...
from functions.seo_lab.utils import parse_creative_outputs, save_creative_outputs, load_local_creative_outputs
from functions.seo_lab.context import SEO_LAB_CONTEXT
...
def load_products_from_yaml(brand_id=None):
    ...
    if brand_id is None:
        ...
        if not brand_id:
            ...
            return {}
    try:
        products_dir = base_dir / 'apps' / brand_id / 'products'
        products = {}
...
def load_format_recommendations_from_platform(brand_id=None):
    ...
    try:
        ...
        brand_registration_file = base_dir / 'apps' / brand_id / 'registration.yaml'
        ...
        format_file = base_dir / 'functions' / 'seo_lab' / 'formats' / f'{platform}.md'
...
def validate_system_state_for_content_production():
    ...
    if brand_id:
        brand_folder = base_dir / 'apps' / brand_id
...
def process_creative_outputs():
    ...
    try:
        from functions.seo_lab.src.copywriter_crew.main import write, write_with_shopify_upload
...
def process_creative_outputs_with_shopify_settings(shopify_settings):
    ...
    try:
        from functions.seo_lab.src.copywriter_crew.main import write_with_shopify_upload
...
def display_manual_shopify_upload_interface():
    ...
    try:
        from functions.seo_lab.shopify_testing import display_shopify_testing_interface
...
def execute_simplified_seo_flow(themes_data):
    ...
    try:
        ...
        try:
            from functions.seo_lab.utils import save_creative_outputs
        ...
        try:
            from functions.seo_lab.utils import load_local_creative_outputs
...
def render_shopify_upload_settings(brand_id, key_prefix="shopify_settings"):
    ...
    """
    try:
        from functions.seo_lab.shopify_api_client import ShopifyBlogAPI
...
def upload_to_shopify_after_generation(brand_folder, brand_id):
    ...
    try:
        ...
        from functions.seo_lab.shopify_api_client import ShopifyBlogAPI, test_shopify_connection
...
def render_content_processing_interface():
    ...
    if content_input:
        try:
            ...
            from functions.seo_lab.utils import parse_creative_outputs
