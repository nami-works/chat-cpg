...
def run(inputs):
    ...
    if selected_products:
        try:
            from functions.seo_lab._seo_lab import get_products_context, load_products_from_yaml
    ...
    for theme_name, theme in themes.items():
        ...
        if products_dict and theme_name in products_dict:
            try:
                from functions.seo_lab._seo_lab import get_optimized_products_context
