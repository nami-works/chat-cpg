...
def test_geocommerce_imports():
    ...
    try:
        ...
        from functions.geocommerce.config import GeoCommerceConfig
        print("  ✅ Config module")
        
        from functions.shopify_connector import ShopifyGraphQLClient
        print("  ✅ Shopify connector")
        
        from functions.geocommerce.api_data_processor import ShopifyDataProcessor
        print("  ✅ Data processor")
        
        from functions.geocommerce.geocommerce_core import GeoCommerceAnalyzer
        print("  ✅ Analytics core")
        
        from functions.geocommerce.geocommerce_shopify import GeoCommerceShopifyApp
        print("  ✅ Streamlit app")
