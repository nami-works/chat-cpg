# RFMify - RFM Analysis Tool for Shopify

## 🎯 Overview

**RFMify** is an advanced RFM Analysis tool designed specifically for e-commerce businesses using Shopify. It provides comprehensive customer segmentation, RFM analysis, and actionable insights to optimize your customer relationships and drive business growth.
...
segments = crmify.analyze_customer_segments(customers_df, orders_df)
print(f"Analyzed {segments['total_customers']} customers")

# Generate insights
insights = crmify.generate_customer_insights(customers_df, orders_df)
...
# Run with coverage
python -m pytest --cov=crmify tests/
```
...
RFMify is part of the Nami ecosystem and is developed for e-commerce RFM analysis and customer insights.
